...
class TraderAccount extends Component
{
    ...
    public function render()
    {
        ...
        $this->totalCashIraqy = $trader->invoices()->where("payment_type", "=", "cash")->sum("sale_price");

        $this->totalCreditDollar = $trader->invoices()->where("payment_type", "=", "credit")->sum("dollar_value");
        $this->totalCreditIraqy = $trader->invoices()->where("payment_type", "=", "credit")->sum("sale_price");
