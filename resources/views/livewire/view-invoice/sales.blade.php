    ...
    <div class="tableList p-3 ">
        ...
        <div class="containerGrroup mt-5">
            <div class="row">
                ...
                <div class="col highlight">{{ $invoice->sale_date }}</div>
            </div>
            <div class="row">
                <div class="col-4">اسم التاجر</div>
                <div class="col highlight">{{ $invoice->trader_name }}</div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col highlight">{{ number_format($invoice->sale_price, 2, '.', ',') }}</div>
            </div>
            <div class="row">
        ...
        <h2 class="mt-5">
            <a class="btn btn-success" href="{{route('print.invoices.sales',[$invoice->id,'ar'])}}"> طباعة عربي</a>
        </h2>
